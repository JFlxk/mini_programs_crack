...
!function(t, o) {
    ...
    function h(e, o, n, r, a, u, h) {
        void 0 === h && (h = function() {}), void 0 === u && (u = "png"), u = c(u), /bmp/.test(u) ? d(e, o, n, r, a, function(e) {
            var o = s(e);
            t(h) && h(i(o, "image/" + u));
    ...
    var f = void 0, l = [ "touchstarted", "touchmoved", "touchended" ], g = {}, v = {
        ...
        !function(n) {
            var r = o, a = t && t.exports == r && t, i = "object" == (void 0 === p ? "undefined" : e(p)) && p;
    ...
    return w.prototype.init = function() {
        ...
        void 0 === c && (c = o), t.outsideBound = function(e, o) {
            ...
            t.ctx.fill(), h.forEach(function(e) {
                t.ctx.beginPath(), t.ctx.strokeStyle = u, t.ctx.lineWidth = s, t.ctx.moveTo(e.start.x, e.start.y), 
